...
#java -jar /usr/local/bin/trimmomatic-0.36.jar PE -threads 3 -trimlog logfile.log -phred33 $R1 $R2 $R3-R1p-phr20.fastq $R3-R1u-phr20.fastq $R3-R2p-phr20.fastq $R3-R2u-phr20.fastq ILLUMINACLIP:/home/elton/bioinformatics-tools/Trimmomatic-0.36/adapters/adapters.fasta:2:30:10 LEADING:20 TRAILING:20 SLIDINGWINDOW:4:15 MINLEN:30

#Run flash with mate pairs
#/opt/local/bin/flash/./flash -M 100 $R1 $R2 #for ARS laptop install
flash -M 200 -t 3 -o $R3 $R3-R1p-phr20.fastq $R3-R2p-phr20.fastq 

#Do some quality trimming on merged file and convert to fasta format
file=$R3.extendedFrags.fastq
