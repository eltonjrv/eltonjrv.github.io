...
$ cd raw_data/
```
1.1.4. Transferring your fastq files to the current work directory (raw_data/) with your most suitable/convenient command or tool (e.g. cp, scp, ftp, WinScp, FileZilla, etc ...). Since we don't know where you are pulling your data from, this step is intentionally left up to you.
