...
>Author: Elton Vasconcelos, DVM, PhD\nResearch Team: Elton Vasconcelos, DVM, PhD; Brian Oakley, MS, PhD; Pedro Diniz, DVM, PhD.
...
```
Catching ZOTU IDs of genus-level ToI from the customized ZOTU table (Ehrlichia and Bartonella are genera examples used herein as ToI):
```
