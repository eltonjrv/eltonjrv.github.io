...
##### This task is strictly dependent on both PCR and Sequencing protocols one has adopted in the Lab.##### In the example below, we are referring to a two-round PCR method which two pairs of adapters were used:##### a) Illumina overhang adapter sequence (For_i5 and Rev_i7) on the 1st round of amplifications, and##### b) iNEXT barcodes (For_A-H - Rev_1-12) on the 2nd round.##### For more details on this approach, please refer to [Faircloth & Glenn, 2012 - PLoS One](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0042543).
