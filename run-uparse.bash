...
usearch -otutab $out/merged.fq -otus $out/otus.fa -strand plus -otutabout $out/otu_table_uparse.tsv

# Create OTU table for ZOTUs	(ZOTUs are 100% identical OTUs)
usearch -otutab $out/merged.fq -zotus $out/zotus.fa -strand plus -otutabout $out/zotu_table_uparse.tsv
